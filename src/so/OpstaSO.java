...
public abstract class OpstaSO {
    ...
    public void izvrsiOperaciju(Pesma odo) throws Exception {
        try {
            konektujSe();
    ...
    protected void proveriPreduslov(Pesma odo) throws Exception {
        if (odo == null) {
            throw new Exception("Tip podatka nije odredjen!!!");
        }
    }

    protected abstract void izvrsiKonkretnuOperaciju(Pesma odo) throws Exception;
